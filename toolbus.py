...
def _bootstrap_internal_toolbus_db(_filename): # this is supposed to be a "private" function
    ...
    db_handle = dsl_type20.DSLType20(dsl_type20.DSLType20_Config(expand_envvars = False, expand_user = False, allow_var_dupes = False, inherit_options = False, variable_decorator = ""))
