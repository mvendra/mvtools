...
def apply_links_filters(items):
    ...
    exclude_list += ["*/LICENSE", "*/README.md", "*/POLICY", "*/hexascconv/dist/README.TXT", "*/built-jar.properties", "*/hexascconv/manifest.mf", "*/hexascconv/build.xml"]
...
def genlinks():
    ...
    v, r = fsquery.makecontentlist(path_mvtools, True, False, True, False, False, False, True, None)
    if not v:
        print(r)
        return False
    items = r
