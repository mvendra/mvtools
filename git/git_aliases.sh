...
alias gilog="git log"
alias gilogline="gilog --oneline"
alias gipus="git push"
alias gipul="git pull --ff-only"
alias giclo="git clone"
alias giclors="giclo --recurse-submodules"
alias giclobra="giclo --single-branch -b"
alias giclobrars="giclo --recurse-submodules --single-branch -b"
alias gibra="git branch"
alias gibrabk="git_backup_current_branch.py"
alias gibradel="gibra -D"
alias gibraname="gibra -m"
alias giswi="git switch"
alias giche="git checkout"
alias gichebra="giche -b"
...
alias giinibar="git init --bare"
alias giconf="git config"
alias gireb="git rebase"
alias girebcon="gireb --continue"
