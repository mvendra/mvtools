...
class MiniparseTest(unittest.TestCase):
    ...
    def testScanLargestOf(self):
        self.assertEqual(miniparse.scan_largest_of("", 0, ["a", "ab", "abc"]), None)
        self.assertEqual(miniparse.scan_largest_of("abc123def", 0, ["a", "ab", "abc"]), 2)
        self.assertEqual(miniparse.scan_largest_of("abc123def", 1, ["a", "ab", "abc"]), None)
        self.assertEqual(miniparse.scan_largest_of("ab123abc", 0, ["a", "ab", "abc"]), 1)
        self.assertEqual(miniparse.scan_largest_of("ababc", 0, ["a", "ab", "abc"]), 1)
        self.assertEqual(miniparse.scan_largest_of("ababc", 1, ["a", "ab", "abc"]), None)
        self.assertEqual(miniparse.scan_largest_of("ababc", 2, ["a", "ab", "abc"]), 2)
        self.assertEqual(miniparse.scan_largest_of("123ull", 0, ["ll", "f", "u", "ull"]), None)
        ...
        self.assertEqual(miniparse.scan_largest_of("123u; // some comment", 3, ["ll", "f", "u", "ull"]), 2)
        self.assertEqual(miniparse.scan_largest_of("123; 456ull // some comment", 3, ["ll", "f", "u", "ull"]), None)
        self.assertEqual(miniparse.scan_largest_of("abc123def", 0, ["abc", "123", "def"]), 0)
        self.assertEqual(miniparse.scan_largest_of("abc123def", 0, ["abc", "abc", "abc"]), 0)
