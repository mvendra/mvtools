...
class BatchRunTest(unittest.TestCase):
    ...
    def testCompareNum(self):

        # eq - default
        self.assertTrue(batch_run._compare_num(1, "1"))
        self.assertTrue(batch_run._compare_num(10, "10"))
        self.assertFalse(batch_run._compare_num(1, "2"))
        self.assertFalse(batch_run._compare_num(10, "11"))

        # eq - explicit
        self.assertTrue(batch_run._compare_num(1, "eq1"))
        self.assertTrue(batch_run._compare_num(10, "eq10"))
        self.assertFalse(batch_run._compare_num(1, "eq2"))
        self.assertFalse(batch_run._compare_num(10, "eq11"))

        # gt - explicit
        self.assertTrue(batch_run._compare_num(2, "gt1"))
        self.assertTrue(batch_run._compare_num(11, "gt10"))
    ...
    def testRunUntil1(self):
        ...
        with mock.patch("generic_run.run_cmd", return_value=(True, dummy_gr_ret)) as dummy1:
            with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy2:
                v, r = batch_run._run_until([self.dummy_taget_full], self.output_folder, [[batch_run._stop_fail, "1"]], "stop-any", "save-all", "dummy-started-time")
                self.assertTrue(v)
    ...
    def testRunUntil2(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_first_full], self.output_folder, [[batch_run._stop_fail, "1"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil3(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_first_full], self.output_folder, [[batch_run._stop_fail, "1"]], "stop-any", "save-fail", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil4(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_second_full], self.output_folder, [[batch_run._stop_fail, "1"]], "stop-any", "save-fail", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil5(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_seventh_full], self.output_folder, [[batch_run._stop_fail, "3"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil6(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_seventh_full], self.output_folder, [[batch_run._stop_fail, "eq3"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil7(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_seventh_full], self.output_folder, [[batch_run._stop_fail, "gt2"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil8(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_third_full], self.output_folder, [[batch_run._stop_count, "9"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil9(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_third_full], self.output_folder, [[batch_run._stop_count, "9"]], "stop-any", "save-fail", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil10(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_third_full], self.output_folder, [[batch_run._stop_count, "eq9"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil11(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_third_full], self.output_folder, [[batch_run._stop_count, "gt8"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil12(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_fourth_full], self.output_folder, [[batch_run._stop_count, "9"]], "stop-any", "save-fail", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil13(self):
        ...
        with mock.patch("generic_run.run_cmd", return_value=(True, dummy_gr_ret)) as dummy1:
            with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy2:
                with mock.patch("maketimestamp.get_timestamp_now_compact", return_value="23012025_185629") as dummy3:
                    v, r = batch_run._run_until([self.dummy_taget_full], self.output_folder, [[batch_run._stop_time, "23012025_185629"]], "stop-any", "save-all", "dummy-started-time")
                    self.assertTrue(v)
                    self.assertEqual(r, None)
                    dummy1.assert_called_with([self.dummy_taget_full])
                    dummy2.assert_called()
                    dummy3.assert_called()
    ...
    def testRunUntil14(self):

        os.mkdir(self.output_folder)

        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_fifth_full], self.output_folder, [[batch_run._stop_tb_sig, "test-stop-sig"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil15(self):

        os.mkdir(self.output_folder)

        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_fifth_full], self.output_folder, [[batch_run._stop_tb_sig, "test-stop-sig"]], "stop-any", "save-fail", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil16(self):

        os.mkdir(self.output_folder)

        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_sixth_full], self.output_folder, [[batch_run._stop_tb_sig, "test-stop-sig"]], "stop-any", "save-fail", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil17(self):

        os.mkdir(self.output_folder)

        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_seventh_full], self.output_folder, [[batch_run._stop_fail, "3"], [batch_run._stop_count, "2"]], "stop-any", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testRunUntil18(self):

        os.mkdir(self.output_folder)

        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-end-time") as dummy:
            v, r = batch_run._run_until([self.test_script_seventh_full], self.output_folder, [[batch_run._stop_fail, "2"], [batch_run._stop_count, "5"]], "stop-all", "save-all", "dummy-started-time")
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testBatchRun2(self):
        ...
        with mock.patch("generic_run.run_cmd", return_value=(True, dummy_gr_ret)) as dummy1:
            with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy2:
                v, r = batch_run.batch_run(self.test_script_first_full, self.output_folder, [["until-fail", "1"]], "stop-any", "save-all", ["test-param1", "test-param2"])
                self.assertTrue(v)
                self.assertEqual(r, None)
    ...
    def testBatchRun6(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_first_full, self.output_folder, [], "stop-any", "save-all", [])
            self.assertFalse(v)
    ...
    def testBatchRun7(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_first_full, self.output_folder, [["invalid-mode", "1"]], "stop-any", "save-all", [])
            self.assertFalse(v)
    ...
    def testBatchRun8(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_first_full, self.output_folder, [["until-fail", None]], "stop-any", "save-all", [])
            self.assertFalse(v)
    ...
    def testBatchRun23(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_first_full, self.output_folder, [["until-time", "1"]], "stop-any", "save-all", [])
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testBatchRun24(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_first_full, self.output_folder, [["until-time", "1"]], "stop-any", "save-fail", [])
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testBatchRun25(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_second_full, self.output_folder, [["until-time", "1"]], "stop-any", "save-fail", [])
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testBatchRun26(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_seventh_full, self.output_folder, [["until-time", "3"]], "stop-any", "save-all", [])
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testBatchRun27(self):
        ...
        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_first_full, self.output_folder, [["until-time", "eq1"]], "stop-any", "save-all", [])
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
    ...
    def testBatchRun28(self):

        # mvtodo

        with mock.patch("maketimestamp.get_timestamp_now", return_value="dummy-time") as dummy:
            v, r = batch_run.batch_run(self.test_script_first_full, self.output_folder, [["until-time", "gt0"]], "stop-any", "save-all", [])
            self.assertTrue(v)
            self.assertEqual(r, None)
            dummy.assert_called()
