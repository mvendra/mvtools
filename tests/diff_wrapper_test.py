...
class DiffWrapperTest(unittest.TestCase):
    ...
    def delegate_setUp(self):
        ...
        create_and_write_file.create_file_contents(self.file2, "def")
        create_and_write_file.create_file_contents(self.file1_empty, "")
        create_and_write_file.create_file_contents(self.file2_empty, "")
        create_and_write_file.create_file_contents(self.file1_hid, "abc")
        create_and_write_file.create_file_contents(self.file2_hid, "def")
        create_and_write_file.create_file_contents(self.file1_esp1, "abc")
        create_and_write_file.create_file_contents(self.file2_esp1, "def")
        create_and_write_file.create_file_contents(self.file1_esp2, "abc")
        create_and_write_file.create_file_contents(self.file2_esp2, "def")
        create_and_write_file.create_file_contents(self.file1_esp3, "abc")
        create_and_write_file.create_file_contents(self.file2_esp3, "def")
        create_and_write_file.create_file_contents(self.file1_esp4, "abc")
        create_and_write_file.create_file_contents(self.file2_esp4, "def")
        self.file1_esp4 += "/"
        self.file2_esp4 += "/"
