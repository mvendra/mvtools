...
class LintFuncIndexerTest(unittest.TestCase):
    ...
    def testLintCycle8(self):
        ...
        test_file = "test_file.txt"
        test_lines = ["loftXright", "left0right", "luftZright"]
        test_plugins_params = {}
        test_shared_state = {}

        test_plugins_params["lint-func-indexer-param-left"] = ["left", "loft"]
        test_plugins_params["lint-func-indexer-param-right"] = ["right"]
        ...
        expected_result1 = ("[test_file.txt:1]: expected index [1], have [X].", [(1, "loft1right")])
        expected_result2 = ("[test_file.txt:2]: expected index [2], have [0].", [(2, "left2right")])
        expected_result3 = None
