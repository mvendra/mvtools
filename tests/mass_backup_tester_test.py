...
class MassBackupTesterTest(unittest.TestCase):
    ...
    def testRunBackupOk(self):
        ...
        tg_folder1_h = path_utils.concat_path(tg_final, "source_test", "folder1.tar.bz2.enc.sha256")
        tg_folder2_e = path_utils.concat_path(tg_final, "source_test", "folder2.tar.bz2.enc")
        tg_folder2_h = path_utils.concat_path(tg_final, "source_test", "folder2.tar.bz2.enc.sha256")
