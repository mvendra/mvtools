...
class OpenAndUpdateFileTest(unittest.TestCase):
    ...
    def testUpdateFileContentsDoesntExist(self):
        ...
        self.assertTrue(mvtools_test_fixture.throwsExcept2(open_and_update_file.update_file_contents, self.content_file, "andthensomemore", mvtools_exception.mvtools_exception))
        self.assertFalse(os.path.exists(self.content_file))
