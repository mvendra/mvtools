...
class TreeWrapperTest(unittest.TestCase):
    ...
    def delegate_setUp(self):
        ...
        v, r = mvtools_test_fixture.makeAndGetTestFolder("tree_wrapper_test")
        if not v:
            return v, r
        ...
        self.assertTrue(create_and_write_file.create_file_contents(self.file_with_space, "abc"))
        self.file_with_sep = path_utils.concat_path(self.test_dir, "file_with_sep.txt")
        self.assertTrue(create_and_write_file.create_file_contents(self.file_with_sep, "abc"))
        self.file_with_sep += "/"
        ...
        self.assertTrue(create_and_write_file.create_file_contents(self.folder_with_space_filler, "abc"))
        ...
        self.assertTrue(create_and_write_file.create_file_contents(self.folder_with_sep_filler, "abc"))
        ...
        self.assertTrue(create_and_write_file.create_file_contents(self.file_hidden, "abc"))

        self.file_esp1 = path_utils.concat_path(self.test_dir, "   file_esp1.txt")
        self.assertTrue(create_and_write_file.create_file_contents(self.file_esp1, "abc"))

        self.file_esp2 = path_utils.concat_path(self.test_dir, "file_esp2.txt   ")
        self.assertTrue(create_and_write_file.create_file_contents(self.file_esp2, "abc"))

        self.file2 = path_utils.concat_path(self.test_dir, "file2.txt")
        self.assertTrue(create_and_write_file.create_file_contents(self.file2, "abc"))
        ...
        self.assertTrue(create_and_write_file.create_file_contents(self.folder2_sub1_file1, "abc"))

        # files in folders

        # folder1
        self.folder1_file1 = path_utils.concat_path(self.folder1, "file1.txt")
        self.assertTrue(create_and_write_file.create_file_contents(self.folder1_file1, "abc"))

        self.folder1_file2 = path_utils.concat_path(self.folder1, "file2.txt")
        self.assertTrue(create_and_write_file.create_file_contents(self.folder1_file2, "abc"))

        # folder2
        self.folder2_file1 = path_utils.concat_path(self.folder2, "file1.txt")
        self.assertTrue(create_and_write_file.create_file_contents(self.folder2_file1, "abc"))

        self.folder2_file2 = path_utils.concat_path(self.folder2, "file2.txt")
        self.assertTrue(create_and_write_file.create_file_contents(self.folder2_file2, "abc"))
    ...
    def testMakeTree(self):
        ...
        self.assertTrue(v)
        self.assertTrue( path_utils.basename_filtered(self.test_dir) in r )
        self.assertTrue( path_utils.basename_filtered(self.file_with_space) in r )
        self.assertTrue( path_utils.basename_filtered(self.file_with_sep) in r )
        self.assertTrue( path_utils.basename_filtered(self.folder_with_space) in r )
        self.assertTrue( path_utils.basename_filtered(self.folder_with_space_filler) in r )
        ...
        self.assertTrue( path_utils.basename_filtered(self.folder1) in r )
        self.assertTrue( path_utils.basename_filtered(self.folder2) in r )
        self.assertTrue( path_utils.basename_filtered(self.folder2_sub1) in r )
        self.assertTrue( path_utils.basename_filtered(self.folder2_sub1_file1) in r )
        self.assertTrue( path_utils.basename_filtered(self.folder1_file1) in r )
        self.assertTrue( path_utils.basename_filtered(self.folder1_file2) in r )
