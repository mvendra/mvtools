...
class ProjCleanupTest(unittest.TestCase):
    ...
    def testProjCleanup7(self):
        ...
        self.assertTrue(create_and_write_file.create_file_contents(dep_macos_file3, "contents"))
        ...
        self.assertTrue(create_and_write_file.create_file_contents(tmp_macos_debug_file8, "contents"))
        self.assertTrue(create_and_write_file.create_file_contents(tmp_macos_release_file9, "contents"))
        ...
        self.assertTrue(create_and_write_file.create_file_contents(out_macos_debug_file14, "contents"))
        self.assertTrue(create_and_write_file.create_file_contents(out_macos_release_file15, "contents"))
    ...
    def testProjCleanup14(self):
        ...
        self.assertTrue(create_and_write_file.create_file_contents(self.target_proj_dep_macos, "contents"))
    ...
    def testProjCleanup16(self):
        ...
        self.assertTrue(create_and_write_file.create_file_contents(self.target_proj_tmp_macos_debug, "contents"))
        self.assertTrue(create_and_write_file.create_file_contents(self.target_proj_tmp_macos_release, "contents"))
    ...
    def testProjCleanup17(self):
        ...
        self.assertTrue(create_and_write_file.create_file_contents(self.target_proj_out_macos_debug, "contents"))
        self.assertTrue(create_and_write_file.create_file_contents(self.target_proj_out_macos_release, "contents"))
