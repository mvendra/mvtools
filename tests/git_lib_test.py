...
class GitLibTest(unittest.TestCase):
    ...
    def testGetHeadUpdatedFiles(self):
        ...
        with open(first_more1, "a") as f:
            f.write("actual modification, fifth")

        with open(first_more2, "a") as f:
            f.write("actual modification, sixth")
    ...
    def testGetStagedRenamedFiles(self):
        ...
        first_more8 = path_utils.concat_path(self.first_repo, " ")
        first_more8_renamed = path_utils.concat_path(self.first_repo, "  ")
        v, r = git_test_fixture.git_createAndCommit(self.first_repo, path_utils.basename_filtered(first_more8), "more8-content8", "commit_msg_more8")
        self.assertTrue(v)
        self.assertFalse(os.path.exists(first_more8_renamed))

        first_more9 = path_utils.concat_path(self.first_repo, os.linesep)
        first_more9_renamed = path_utils.concat_path(self.first_repo, "%s%s" % (os.linesep, os.linesep))
        v, r = git_test_fixture.git_createAndCommit(self.first_repo, path_utils.basename_filtered(first_more9), "more9-content9", "commit_msg_more9")
        self.assertTrue(v)
        self.assertFalse(os.path.exists(first_more9_renamed))
        ...
        self.assertTrue(path_utils.copy_to_and_rename(first_more8, self.first_repo, path_utils.basename_filtered(first_more8_renamed)))
        self.assertTrue(path_utils.copy_to_and_rename(first_more9, self.first_repo, path_utils.basename_filtered(first_more9_renamed)))
        os.unlink(first_more6)
        os.unlink(first_more7)
        os.unlink(first_more8)
        os.unlink(first_more9)
        ...
        self.assertTrue(os.path.exists(first_more8_renamed))
        self.assertTrue(os.path.exists(first_more9_renamed))
        ...
        self.assertTrue(any(first_more8 in s for s in r))
        self.assertTrue(any(first_more8_renamed in s for s in r))
        self.assertTrue(any(first_more9 in s for s in r))
        self.assertTrue(any(first_more9_renamed in s for s in r))
        for x in r:
            self.assertTrue(os.path.exists(x[1]))
    ...
    def testGetUnversionedFiles(self):
        ...
        self.assertTrue(first_more4 in r)
        self.assertTrue(first_more5 in r)
        self.assertTrue(first_sub_more6 in r)
